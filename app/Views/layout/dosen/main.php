...
<head>
    ...
    <title><?= $title ?? 'Dashboard Dosen' ?> | SIPAKU</title>
    ...
    <style>
        ...
        /* Dosen specific adjustments - keeping same structure as admin */
...
<body class="bg-gray-100 min-h-screen flex flex-col">
    <!-- Include Navbar -->
    <?= $this->include('layout/dosen/navbar') ?>

    <!-- Include Sidebar -->
    <?= $this->include('layout/dosen/sidebar') ?>
    ...
    <div class="main-wrapper">
        ...
        <main id="main-content" class="content-area transition-all duration-300 ease-in-out lg:ml-64">
            ...
            <!-- Include Footer -->
            <?= $this->include('layout/dosen/footer') ?>
        </main>
    </div>
