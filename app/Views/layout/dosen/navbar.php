    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                ...
                <button id="navbar-toggle" class="text-white hover:bg-blue-700 p-2 rounded-lg mr-3 transition-all duration-300 cursor-pointer md:hidden">
                ...
                <button id="navbar-toggle-desktop" class="hidden md:block text-white hover:bg-blue-700 p-2 rounded-lg ml-4 transition-all duration-300 cursor-pointer">
                    <svg class="w-6 h-6 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
                    </svg>
                </button>
                    ...
                    <div id="user-dropdown" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg py-2 z-50 border border-gray-200">
                        ...
                        <div class="px-4 py-3 border-b border-gray-100">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-sm font-medium text-gray-900"><?= session()->get('nama_user') ?? 'Dosen' ?></div>
                                    <div class="text-xs text-gray-500">NIDN: <?= session()->get('kode') ?? '-' ?></div>
                                    <div class="text-xs text-blue-600 font-medium">Dosen</div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-4">
            ...
            <div id="breadcrumb-page-info" class="hidden lg:flex items-center space-x-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900"><?= $title ?? 'Dashboard Dosen' ?></h2>
                        <p class="text-sm text-gray-500">Portal Akademik Dosen</p>
                    </div>
                </div>
            ...
            <nav class="flex items-center space-x-2 text-sm order-2 lg:order-2">
                <a href="<?= base_url('dosen/dashboard') ?>" class="text-blue-600 hover:text-blue-800 transition duration-200">
