    ...
    <div class="p-6">
        <nav class="space-y-2">
            ...
            <a href="<?= base_url('admin/mata-kuliah') ?>"
                class="flex items-center px-4 py-3 text-gray-600 <?= (strpos(current_url(), 'mata-kuliah') !== false) ? 'bg-yellow-50 border-r-4 border-yellow-400 text-gray-700' : 'hover:bg-gray-50' ?> rounded-l-lg transition duration-200">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="px-4 py-2">
                <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Sistem</h3>
            </div>

            <a href="<?= base_url('admin/users') ?>"
                class="flex items-center px-4 py-3 text-gray-600 <?= (strpos(current_url(), 'admin/users') !== false) ? 'bg-yellow-50 border-r-4 border-yellow-400 text-gray-700' : 'hover:bg-gray-50' ?> rounded-l-lg transition duration-200">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
